...
INSERT INTO `category` (`id`, `name`, `status`, `created`, `created_by`, `modified`, `modified_by`, `is_home`, `display`, `ordering`) VALUES
(1, 'Thể thao', 'inactive', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hailan', 'yes', 'list', 1),
(2, 'Giáo dục', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hailan', 'yes', 'grid', 2),
(3, 'Sức khỏe', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:33', 'hailan', 'yes', 'list', 3),
(4, 'Du lịch', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:30', 'hailan', 'yes', 'grid', 4),
(5, 'Khoa học', 'inactive', '2019-05-04 00:00:00', 'admin', '2019-05-12 00:00:00', 'hailan', 'yes', 'grid', 5),
(6, 'Số hóa', 'inactive', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:38', 'hailan', 'yes', 'grid', 6),
(7, 'Xe - Ô tô', 'active', '2019-05-04 00:00:00', 'admin', '2019-05-15 15:04:36', 'hailan', 'yes', 'grid', 7),
(8, 'Kinh doanh', 'inactive', '2019-05-12 00:00:00', 'hailan', '2021-10-17 11:34:18', 'admin', 'yes', 'grid', 8);
...
INSERT INTO `contact` (`id`, `username`, `email`, `phone`, `contact`, `status`, `created`, `ip_address`) VALUES
(2, 'Đinh Công Lâm', 'lam.dinhcong@vti.com.vn', '0702620123', 'Bạn ghi đầy đủ thông tin cá nhân và vấn đề cần tra đổi với ZendVN vào form bên dưới, sau khi nhận được thông tin này chúng tôi sẽ liên hệ với các bạn trong thời gian ngắn nhất', 'inactive', '2021-10-17 00:00:00', '127.0.0.1'),
(3, 'Đinh Công Lâm', 'lam.dinhcong@vti.com.vn', '0702620123', 'Xin chào', 'inactive', '2021-10-17 00:00:00', '127.0.0.1');
...
INSERT INTO `menu` (`id`, `name`, `link`, `status`, `ordering`, `type_menu`, `type_open`) VALUES
(1, 'Trang chủ', '/', 'active', 1, 'link', '_self'),
(2, 'Danh mục', '#', 'active', 2, 'category_article', '_self'),
(3, 'Liên hệ', '/contact', 'active', 6, 'link', '_self'),
(4, 'About', '/about', 'inactive', 4, 'link', '_self'),
(5, 'Thư viện hình ảnh', '/thu-vien-hinh-anh', 'active', 4, 'link', '_self'),
(7, 'Tin tức tổng hợp', '/tin-tuc-tong-hop', 'active', 5, 'link', '_self');
...
(1, 'Express Thể Thao', 'active', 'https://vnexpress.net/rss/the-thao.rss', 1, 'vnexpress', '2021-10-08 00:00:00', 'hailan', '2021-10-10 19:29:21', 'admin'),
(2, 'Express Xe', 'inactive', 'https://vnexpress.net/rss/oto-xe-may.rss', 2, 'vnexpress', '2021-10-08 00:00:00', 'hailan', NULL, NULL);
...
--
-- テーブルのデータのダンプ `setting`
--

INSERT INTO `setting` (`id`, `key_value`, `value`, `status`, `created`, `created_by`, `modified`, `modified_by`) VALUES
(1, 'setting_general', '{\"logo\":\"\\/images\\/gallery\\/718427.png\",\"hotline\":\"070 2652 0123\",\"copyright\":\"© 2020 - Bản quyền của Công Ty Lập Trình Zend Việt Nam\",\"date_time\":\"Từ 8h - 18h từ thứ 2 đến thứ 7\",\"address\":\"Tầng 5, Tòa nhà Sondo, 62A Phạm Ngọc Thạch, Phường 6, Quận 3 , HCM\",\"introduce\":\"<p>Tầng 5, T&ograve;a nh&agrave; Sondo, 62A Phạm Ngọc Thạch, Phường 6, Quận 3 , HCM<\\/p>\\r\\n\\r\\n<p>Từ 8h - 18h từ thứ 2 đến thứ 7<\\/p>\\r\\n\\r\\n<p>&nbsp;<\\/p>\\r\\n\\r\\n<p>&copy; 2020 - Bản quyền của C&ocirc;ng Ty Lập Tr&igrave;nh Zend Việt Nam<\\/p>\",\"map\":\"<iframe src=\\\"https:\\/\\/www.google.com\\/maps\\/embed?pb=!1m14!1m8!1m3!1d12959.812078759736!2d139.7513269!3d35.7027737!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x92c283a52bac930f!2sVTI%20Japan%20Co%2C%20Ltd.!5e0!3m2!1svi!2sjp!4v1634270524935!5m2!1svi!2sjp\\\" width=\\\"500\\\" height=\\\"400\\\" style=\\\"border:0;\\\" allowfullscreen=\\\"\\\" loading=\\\"lazy\\\"><\\/iframe>\"}', NULL, NULL, NULL, NULL, NULL),
(2, 'setting_email_bcc', '{\"bcc\":\"hathiutnhung0101@gmail.com\"}', NULL, NULL, NULL, NULL, NULL),
(3, 'setting_email_account', '{\"email_account\":\"dinhconglam2306@gmail.com\",\"password\":\"ereigocbxtbcajls\"}', NULL, NULL, NULL, NULL, NULL),
(4, 'setting_social', '{\"youtube\":\"http:\\/\\/proj_news_8x.xyz\\/admin\\/setting?type=email\",\"facebook\":\"http:\\/\\/proj_news_8x.xyz\\/admin\\/setting?type=social\"}', NULL, NULL, NULL, NULL, NULL);
...
(3, 'Ưu đãi học phí', 'Tổng hợp các trương trình ưu đãi học phí hàng tuần, hàng tháng đến tất các các bạn với các mức giảm đặc biệt 50%, 70%,..', 'https://zendvn.com/uu-dai-hoc-phi-tai-zendvn/', 'LWi6hINpXz.jpeg', '2019-04-24 00:00:00', 'hailan', '2021-10-17 12:02:47', 'admin', 'active', 11);
...
(1, 'admin', 'admin@gmail.com', 'admin123456', 'fcea920f7412b5da7be0cf42b8c93759', '1ctW8mj8vq.png', 'admin', '2014-12-10 08:55:35', 'admin', '2019-05-04 14:47:14', 'hailan', 'active'),
(2, 'hailan', 'hailan@gmail.com', 'hailan', 'fcea920f7412b5da7be0cf42b8c93759', '1eSGmvZ3gM.jpeg', 'admin', '2014-12-13 07:20:03', 'admin', '2019-05-04 08:47:04', 'hailan', 'active'),
...
(4, 'user4561', 'user456@gmail.com', 'user456', 'e10adc3949ba59abbe56e057f20f883e', '54rW46Z0dN.png', 'member', '2019-05-04 00:00:00', 'admin', '2021-10-15 00:00:00', 'hailan', 'active');
